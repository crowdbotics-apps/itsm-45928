"""
Django settings for itsm_45928 project.
...
WSGI_APPLICATION = 'itsm_45928.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "itsm_45928 API",
    "DESCRIPTION": "API documentation for itsm_45928 App",
    "VERSION": "v1",
}
